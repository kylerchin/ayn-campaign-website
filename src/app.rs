...
fn HomePage() -> impl IntoView {
    ...
    view! {
        ...
        <div 
        class=" gaze1 bg-no-repeat bg-cover bg-[center_right_-8rem] bg-[center_right_-5rem] md:bg-center" class=""
        >
        ...
        <div class="container mx-auto py-48 md:py-96 min-[20000px]:py-[40em]">
            ...
            <h1 class="text-white amster text-3xl md:text-4xl font-bold">"Kyler Chin"</h1>
